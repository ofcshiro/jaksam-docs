...
description: "Recupera los datos de una plantilla de misión del lado del servidor, como sus opciones, etiqueta o descripción."
icon: "clipboard-list"
---

Export para obtener una plantilla de misión del lado del servidor, en caso de que quieras recuperar sus datos — por ejemplo opciones, etiqueta, descripción, etc.
