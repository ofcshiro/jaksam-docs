...
Los módulos son una forma sencilla de que Shops Creator reemplace ciertas funciones por defecto (barra de progreso, dispatch, logs).

Para elegir un módulo existente, abre el menú `/shopscreator`, ve a ajustes, y elígelo. Así de fácil.
...
<Tabs>
  <Tab title="Banca">
    <Steps>
      <Step title="Ve a la carpeta de módulos">
        Ve a la carpeta `shops_creator/_modules/banking`.
      </Step>
  ...
  <Tab title="Dispatch">
    <Steps>
      <Step title="Ve a la carpeta de módulos">
        Ve a la carpeta `shops_creator/_modules/dispatch`.
      </Step>
      <Step title="Duplica un módulo existente">
  ...
  <Tab title="Logs">
    <Steps>
      <Step title="Ve a la carpeta de módulos">
        Ve a la carpeta `shops_creator/_modules/logs`.
      </Step>
      <Step title="Duplica un módulo existente">
  ...
  <Tab title="Text UI">
    <Steps>
      <Step title="Ve a la carpeta de módulos">
        Ve a la carpeta `shops_creator/_modules/textui`.
      </Step>
      <Step title="Duplica un módulo existente">
