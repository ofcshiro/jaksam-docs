---
title: "Cómo dar llaves con el comando /car"
description: "Da automáticamente las llaves de un vehículo al ser generado con el comando /car, para las configuraciones más comunes de ESX y QBCore."
icon: "car"
---

Para dar automáticamente las llaves de un vehículo recibido con el comando `/car`, consulta los ejemplos a continuación.

<Note>
  En los siguientes ejemplos, **la línea de integración** ya ha sido añadida al código previamente existente.
</Note>
...
ESX.RegisterCommand('car', 'admin', function(xPlayer, args, showError)
	...
	ESX.OneSync.SpawnVehicle(args.car, playerCoords, playerHeading, upgrades, function(networkId)
		if networkId then
			...
			-- integración de vehicles keys de jaksam
