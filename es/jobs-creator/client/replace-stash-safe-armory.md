...
description: "Usa tu propio sistema de stash, safe o armory en lugar del predeterminado creando un módulo stash."
icon: "box"
---
...
<Steps>
  ...
  <Step title="Busca el tipo de módulo stash">
    Busca el módulo de tipo **stash** existente para usarlo como plantilla.
  </Step>
  <Step title="Duplica el módulo">
    Copia el módulo stash existente y pégalo en la misma carpeta.
  </Step>
  <Step title="Renombra la copia">
    Renombra la copia pegada para que coincida con tu integración (por ejemplo, `my_stash.lua`).
  </Step>
