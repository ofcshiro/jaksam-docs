...
Tu peux utiliser un [module](/fr/drugs-creator/modules) Drugs Creator si tu veux utiliser ta propre barre de progression.
...
```lua
-- Ceci créera une commande pour afficher une barre de progression rouge
