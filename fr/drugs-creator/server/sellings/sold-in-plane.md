---
title: "Sold in plane"
description: "Déclenché côté serveur après qu'un joueur vende des drogues en étant dans un avion."
icon: "plane"
---

Déclenché après qu'un joueur vende en étant dans un avion (pour chaque item vendu).
