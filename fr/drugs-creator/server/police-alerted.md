...
Déclenché quand la police est alertée côté serveur (seulement **1** fois par alerte, contrairement à la version côté client qui se déclenche pour chaque joueur).
