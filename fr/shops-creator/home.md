---
title: "Shops Creator"
description: "Documentation officielle du script FiveM Shops Creator, incluant le lien vers le fil du forum et la boutique."
icon: "cart-shopping"
---

Voici la documentation officielle de **Shops Creator**.
...
<CardGroup cols={2}>
  <Card title="Installation" icon="download" href="/fr/shops-creator/installation">
    Installe et fais fonctionner Shops Creator sur ton serveur.
  </Card>

  <Card title="Guides" icon="book-open" href="/fr/shops-creator/how-to-use-images-for-items">
    Utiliser des images pour les items et autres guides.
  </Card>

  <Card title="Référence développeur" icon="code" href="/fr/shops-creator/client">
